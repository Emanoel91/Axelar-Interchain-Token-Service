...
st.markdown(
    ...
    <div style="background-color: #fec7a2; padding: 15px; border-radius: 10px; border: 1px solid #fec7a2;">
        Interchain Token Service (ITS) scales tokens to many chains: supporting both existing and newly minted tokens; preserving native-like 
        fungibility and functionality on connected chains; automating deployment and maintenance so teams can easily manage supply over a 
        network that is open, scalable and secure.
    </div>
    """,
    unsafe_allow_html=True
)
...
st.markdown(
    ...
    <div style="font-size: 16px;">
        ...
        <div style="display: flex; align-items: center; gap: 10px;">
            <img src="https://axelarscan.io/logos/logo.png" alt="Axelar" style="width:20px; height:20px;">
            <a href="https://interchain.axelar.dev/" target="_blank">Interchain Token Service</a>
        </div>
        <div style="display: flex; align-items: center; gap: 10px;">
